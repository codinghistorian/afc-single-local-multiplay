    ...
    match skill {
        PenguinSkillId::FishTorpedo => {
            let spawn = grounded_position(
                origin + facing * PENGUIN_FISH_TORPEDO_SPAWN_FORWARD,
                0.26 * size_scale,
            );
        ...
        PenguinSkillId::SnowHillRamp => {
            let distance = if aim_held {
                PENGUIN_SNOW_HILL_FAR_DISTANCE
            } else {
                PENGUIN_SNOW_HILL_NEAR_DISTANCE
            };
        ...
        PenguinSkillId::SnowSlopeRide => {
            let spawn = grounded_position(
                origin + facing * PENGUIN_SNOW_SLOPE_RIDE_SPAWN_FORWARD * size_scale,
                0.02,
            );
        ...
        PenguinSkillId::SnowfortCannon => {
            let spawn = grounded_position(
                origin + facing * PENGUIN_SNOWFORT_SPAWN_FORWARD * size_scale,
                0.02,
            );
        ...
        PenguinSkillId::SpringPeck => {
            let spawn = grounded_position(
                origin + facing * PENGUIN_SPRING_PAD_SPAWN_FORWARD * size_scale,
                0.03,
            );
            spawn_spring_pad(
                commands,
        ...
        PenguinSkillId::BodySlam => {
            let distance = if aim_held {
                PENGUIN_BODY_SLAM_FAR_DISTANCE
            } else {
                PENGUIN_BODY_SLAM_NEAR_DISTANCE
            };
