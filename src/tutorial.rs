...
use crate::control_settings::{
    CONTROLLER_GAMEPLAY_BINDINGS, ControlPreferences, ControllerDeviceInfo, ControllerFamily,
    controller_info,
};
...
pub fn observe_tutorial_objective(
    ...
    let settled = match step.objective {
        ...
        TutorialObjective::ItemThrow(_) => player_recovered && session.completion_activation_seen,
